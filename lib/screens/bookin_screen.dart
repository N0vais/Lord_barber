import 'package:barber_lord_definitivo/components/butomLogin.dart';
import 'package:barber_lord_definitivo/components/custon_appbar.dart';
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: Butomlogin(
                ...
                onPressed: () {
                  Navigator.of(context).pushNamed('succes _bookin');
                },
